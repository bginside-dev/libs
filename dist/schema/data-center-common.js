...
var data_center_common_exports = {};
__export(data_center_common_exports, {
  DataCenterBaseSchema: () => DataCenterBaseSchema,
  DataCenterDeleteSchema: () => DataCenterDeleteSchema,
  DataCenterPostSchema: () => DataCenterPostSchema,
  DataCenterPutSchema: () => DataCenterPutSchema,
  ValidatePostSchema: () => ValidatePostSchema
});
module.exports = __toCommonJS(data_center_common_exports);
