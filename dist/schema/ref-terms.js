...
// src/schema/ref-terms.ts
var ref_terms_exports = {};
__export(ref_terms_exports, {
  RefTermsSchema: () => RefTermsSchema
});
module.exports = __toCommonJS(ref_terms_exports);
...
// src/schema/ref-terms.ts
var RefTermsSchema = DataCenterBaseSchema.extend({
  days: onlyOverride.number().default(0).optional()
});
