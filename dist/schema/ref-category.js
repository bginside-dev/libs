...
// src/schema/ref-category.ts
var ref_category_exports = {};
__export(ref_category_exports, {
  RefCategorySchema: () => RefCategorySchema
});
module.exports = __toCommonJS(ref_category_exports);
...
// src/schema/ref-category.ts
var RefCategorySchema = DataCenterBaseSchema.extend({
  colorCode: onlyOverride.string().optional()
});
