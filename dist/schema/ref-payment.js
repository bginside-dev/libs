...
// src/schema/ref-payment.ts
var ref_payment_exports = {};
__export(ref_payment_exports, {
  RefPaymentSchema: () => RefPaymentSchema
});
module.exports = __toCommonJS(ref_payment_exports);
...
// src/schema/ref-payment.ts
var RefPaymentSchema = DataCenterBaseSchema.extend({
  operator: onlyOverride.number().default(0).optional(),
