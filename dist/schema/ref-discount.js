...
// src/schema/ref-discount.ts
var ref_discount_exports = {};
__export(ref_discount_exports, {
  RefDiscountSchema: () => RefDiscountSchema
});
module.exports = __toCommonJS(ref_discount_exports);
...
// src/schema/ref-discount.ts
var RefDiscountSchema = DataCenterBaseSchema.extend({
  discRate: onlyOverride.number().default(0).optional(),
  lessTax: onlyOverride.boolean().default(false).optional(),
  senior: onlyOverride.boolean().default(false).optional(),
  promo: onlyOverride.boolean().default(false).optional(),
  claim: onlyOverride.boolean().default(false).optional(),
  hide: onlyOverride.boolean().default(false).optional()
});
